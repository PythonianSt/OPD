  ...
  <div class="card">
    ...
    <form method="post" action="/submit" autocomplete="on">
      ...
      <div class="grid">
        ...
        <label class="field full">คณะ<select name="faculty">{faculty_options}</select></label>
      </div>
      ...
      <label class="radio"><input type="checkbox" required> ข้าพเจ้าตรวจสอบข้อมูลก่อนส่งแล้ว</label>
      <div style="height:14px"></div>
...
<div class="a4">
  ...
  <table>
    ...
    <tr><th>บัตรประชาชน</th><td>{esc(row.get('citizen_id',''))}</td><th>เพศ</th><td>{esc(row.get('sex',''))}</td></tr>
...
<div class="wrap">
  <div class="card no-print">
    ...
    <table><thead><tr><th>เวลา</th><th>ชื่อ-นามสกุล</th><th>HN</th><th>อาการนำ</th><th></th></tr></thead>
...
<div class="wrap">
  <div class="card no-print">
    ...
    <p class="small">เลือกกระดาษ A4 และ Scale 100% ในหน้าต่าง Print ของ browser</p>
  </div>
  {a4_content(row)}
</div>"""
